...
<div class="row">
    <div class="col-xl-8 order-xl-1">
        <div class="card">
            <form class="needs-validation" novalidate action="{{url('material/update/'.$result[0]['id'])}}" method="post" id="forms">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="input-username" class="form-control" placeholder="Basic programing" name="material_image">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <img style='width:500px;height:300px' src="{{$result[0]['material_image']}}" class="rounded float-left" alt="...">    
                                @else
